                ...
                <form action="{{ route('ferry.update', $ferry->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                            ...
                            is-invalid
                        @enderror"
                            name="nom" id="nom" placeholder="Nom du ferry" value="{{ old('nom', $ferry->nom) }}">
                        @error('nom')
                    ...
                    <div class="mb-3">
                        ...
                        @enderror"
                            ...
                            value="{{ old('longueur', $ferry->longueur) }}">
                        @error('longueur')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text"
                            ...
                            is-invalid
                        @enderror"
                            name="largeur" id="largeur" placeholder="Largeur en mètre"
                            value="{{ old('largeur', $ferry->largeur) }}">
                        @error('largeur')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text"
                            ...
                            is-invalid
                        @enderror"
                            name="vitesse" id="vitesse" placeholder="Vitesse en noeuds"
                            value="{{ old('vitesse', $ferry->vitesse) }}">
                        @error('vitesse')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="file"
                            ...
                            is-invalid
                        @enderror"
                            name="photo" id="photo" value="{{ old('photo', $ferry->photos) }}">
                        @error('photo')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
